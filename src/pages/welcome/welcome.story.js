export default function WelcomeStory() {
  return (
    <p>
      ...
      fruition: <br />
      <br />
      First, to my children, <strong>Elizabeth</strong> and <strong>Benjamin</strong>, who were my inspiration for the
      original characters and who made it fun for me to tell bedtime stories. These stories remind me of those many
      nights especially when I came up with the infamous phrase <i-lg>“to be continued”</i-lg>- and the first words out
      of your mouths were: <i-lg>“No dad! Finish it!”</i-lg>
      . <br />
      <br />
      Second, to my illustrator, <strong>Aleksandra Adamska Rzepka</strong>. You are an amazingly gifted artist! I am so
